...
-- Introducir datos en la tabla "Equipos"
INSERT INTO Equipos (Codigo, Nombre, Estadio, Aforo, Fundacion, Ciudad, Presidente) VALUES
...
-- Introducir datos en la tabla "Presidentes"
INSERT INTO Presidentes (Dni, Nombre, Apellidos, Fecha_nac, Anno) VALUES
...
-- Introducir datos en la tabla "Partidos"
INSERT INTO Partidos (Codigo, Fecha, Equipo_local, Equipo_visitante) VALUES
  ('J112', '2016-10-02', 'EQ001', 'EQ002'),
  ('J134', '2016-10-02', 'EQ003', 'EQ004'),
  ('J231', '2016-10-09', 'EQ003', 'EQ001'),
  ('J242', '2016-10-09', 'EQ004', 'EQ002');

-- Introducir datos en la tabla "Jugadores"
INSERT INTO Jugadores (Codigo, Nombre, Fecha, Posicion, Cod_equipo) VALUES
...
-- Introducir datos en la tabla "Goles"
INSERT INTO Goles (Cod_partido, Minuto, Descripcion, Cod_jugador, PropiaPuerta) VALUES
